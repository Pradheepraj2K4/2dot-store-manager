...
import Gstr2ReportPage from "./components/reports/Gstr2ReportPage";
          ...
          <ProtectedRoute>
            <AppLayout>
              <Routes>
                ...
                <Route path="/gstr1-report" element={<Gstr1ReportPage />} />
                <Route path="/gstr2-report" element={<Gstr2ReportPage />} />
