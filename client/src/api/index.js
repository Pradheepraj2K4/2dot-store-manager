...
export const ledgerApi = {
  ...
  getOutstandingByType: (typeId) =>
    api.get(`/ledgers/outstanding/type/${typeId}`),
...
export const transactionApi = {
  ...
  getNextRunningNumber: (entryType) =>
    api.get(`/transactions/next-number?entryType=${entryType}`),
};
...
export const interestApi = {
  ...
  getPendingByLedger: (ledgerId) =>
    api.get(`/interest/ledger/${ledgerId}/pending`),
...
export const expenseApi = {
  ...
  getSuggestions: (q) =>
    api.get(`/expenses/suggestions?q=${encodeURIComponent(q)}`),
  getSummary: (params = {}) => {
    const qs = new URLSearchParams(params).toString();
...
export const itemApi = {
  ...
  adjustStock: (adjustments) =>
    api.post("/items/adjust-stock", { adjustments }),
  getImeis: (id) => api.get(`/items/${id}/imeis`),
  getImeiBreakdown: (id) => api.get(`/items/${id}/imeis/breakdown`),
  getBatches: (id) => api.get(`/items/${id}/batches`),
  getNextBatchNumber: () => api.get("/items/next-batch-number"),
};
...
export const waiterApi = {
  ...
  setDefault: (id, isDefault = true) =>
    api.put(`/waiters/${id}/default`, { isDefault }),
